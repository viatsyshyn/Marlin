 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_HYSTERESIS 7 // Degrees Celsius
...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_SPEED 192        // 255 == full speed
#endif
...
#define ENCODER_10X_STEPS_PER_SEC 160    // If the encoder steps per sec exceeds this value, multiply steps moved x10 to quickly advance the value
#define ENCODER_100X_STEPS_PER_SEC 500  // If the encoder steps per sec exceeds this value, multiply steps moved x100 to really quickly advance the value
